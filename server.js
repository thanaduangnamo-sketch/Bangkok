...
<body class="min-h-screen flex flex-col justify-between text-slate-800">
    ...
    <div id="loadingScreen"
        ...
        <div class="flex items-center gap-2 mb-4">
            ...
            <span id="loadingPercent"
                  class="text-xs font-mono font-bold text-cyan-400">
                0%
            </span>
    ...
    <div
        ...
        <div class="bg-white rounded-3xl shadow-2xl border border-slate-100 w-full max-w-md p-6 sm:p-8 relative">
            ...
            <!-- CLOSE -->
            <button
                onclick="playClickSound(); toggleAuthModal(false)"
            ...
            <form
                id="loginForm"
                onsubmit="handleAuth(event, 'login')"
                class="space-y-4">
            ...
            <!-- NO DISCORD SYSTEM -->
            <div class="mt-6 p-4 bg-slate-50 rounded-2xl border border-slate-200 text-center">
    ...
    <div
        ...
        <div class="bg-white rounded-3xl shadow-2xl border border-slate-100 w-full max-w-md p-6 sm:p-8 relative text-center">
            ...
            <button
                onclick="playClickSound(); toggleTopUpModal(false)"
                class="absolute top-5 right-5 text-slate-400 hover:text-black font-bold text-xl">
                ✕
            </button>
    ...
    <main class="max-w-6xl mx-auto px-6 py-12">
        ...
        <div class="text-center max-w-3xl mx-auto mb-20">
            ...
            <div class="inline-flex items-center gap-2 px-4 py-2 bg-slate-100 rounded-full border border-slate-200 text-slate-700 text-xs font-semibold mb-6 shadow-sm">
                ...
                <span>
                    แพลตฟอร์มสินค้าและบริการดิจิทัล
                </span>
    ...
    ========================== -->
    <footer
        class="w-full border-t border-slate-200 bg-white py-6 text-center text-xs font-medium text-slate-500">
    ...
    <script>
        ...
        function triggerCaptchaClick() {
            ...
            if (
                ...
                alert(
                    'กรุณาติ๊กช่อง "ฉันไม่ใช่โปรแกรมอัตโนมัติ" ก่อนครับ'
                );
        ...
        function switchForm(type) {
            ...
            if (type === 'login') {
                ...
                loginTab.className =
                    'w-1/2 py-3 text-center font-bold text-black border-b-2 border-black transition flex items-center justify-center gap-2';

                registerTab.className =
                    'w-1/2 py-3 text-center font-semibold text-slate-400 hover:text-black border-b-2 border-transparent transition flex items-center justify-center gap-2';
        ...
        function handleAuth(
            ...
            /*
             * หมายเหตุ:
             * ระบบนี้เป็นระบบ Login ฝั่งหน้าเว็บ
             * ข้อมูลถูกเก็บไว้ใน localStorage
             */
